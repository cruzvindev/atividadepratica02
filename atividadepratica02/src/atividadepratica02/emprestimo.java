...
public class emprestimo {
	...
	public void imprimir() {
		...
		System.out.println("O valor do seu emprestimo é: " + valorEmprestimo+"R$");
		System.out.println("O seu percentual de juros é: " + percentualJurosMes +"%");
		System.out.println("Você tem " + mesesParaPagar + " meses para pagar");
	}
